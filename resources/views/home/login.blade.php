...
<body style="background: linear-gradient(to bottom, #026597 0%, #990099 120%);">
    <div class="container-fluid vh-100 d-flex flex-column justify-content-lg-center">
        <div class="row">
            <div class="col-6 col-lg-6 offset-lg-3">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{route('usuarios.login')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="rut" id="rut" name="rut" class="form-control" placeholder="Indique RUT sin puntos, con guión y con digito verificador">
                                        </div>
                                        <div class="form-group">
